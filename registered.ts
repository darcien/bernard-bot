...
const getAllCommandsUrl = `https://discord.com/api/v10/applications/${config.DISCORD_APPLICATION_ID}/commands`;
...
async function getAllCommands() {
  ...
  console.log(res);
  const commandCount =
    "length" in res && typeof res.length === "number" ? res.length : null;
