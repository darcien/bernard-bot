...
// chatDefinition is disabled because it needs a new LLM provider.
// When reimplemented, it should use a deferred response (DeferredChannelMessageWithSource)
// since the LLM call is async, giving Discord the "Bernard is thinking..." loading state.
